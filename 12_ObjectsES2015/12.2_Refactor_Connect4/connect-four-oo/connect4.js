...
class Game {
  ...
  newGame() {
    ...
    start.addEventListener('click', evt => {
      evt.preventDefault();
      console.log('this obj ref is', this);
      this.WIDTH = this.WIDTH;
      this.HEIGHT = this.HEIGHT;
      this.board = [];
      this.winFlag = false;
      const rows = this.HTMLboard.querySelectorAll('tr');
      for (let row of rows) {
        row.remove();
      }
      const player1 = new Player(document.querySelector('#p1_col').value, document.querySelector('#p1_name').value);
      const player2 = new Player(document.querySelector('#p2_col').value, document.querySelector('#p2_name').value);
