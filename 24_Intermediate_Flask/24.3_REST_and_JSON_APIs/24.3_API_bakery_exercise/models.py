...
class Cupcake(db.Model):
    ...
    def serialize(self):
        """Returns an object representation that JSON can handle"""
        return {
            'id': self.id,
            'flavor': self.flavor,
            'size': self.size,
    ...
    def __repr__(self):
        return f"<Cupcake {self.id} flavor={self.flavor} size={self.size}, rating={self.rating} img={self.image}>"
# EXAMPLES
# Examples of models
# class User(db.Model):
